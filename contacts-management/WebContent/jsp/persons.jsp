							...
							<tbody>
								<c:forEach var="person" items="${persons}">
									<tr>
										...
										<td><a class="btn btn-mini btn-primary" href='<c:out value="${url}person/edt/${person.id}" escapeXml="true" />'>Edit</a> | <a  class="btn btn-mini btn-danger" href='<c:out value="${url}person/del/${person.id}" escapeXml="true" />'>Delete</a></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
